...
In the ordered domains of decision-making, where cause and effect are clear, KRIs are appealing tools. They provide a systematic way to monitor known variables and ensure compliance with established procedures. They fit neatly into reports and give boards a quantifiable basis for oversight. The practice creates a powerful sense of assurance and a clear framework of targets, incentives and mechanisms that middle and lower management will focus their behaviour on optimising. The problem is that the greatest threats to the enterprise do not live in the ordered world. They are born in a chaotic plasma of incentives, optimisation and the complexity of second and third order effects, where historical data is not a guide but a trap.
