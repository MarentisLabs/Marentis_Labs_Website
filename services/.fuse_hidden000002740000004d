---
layout: service
title: "The Adversarial Methodology"
headline: "The Adversarial Methodology"
strapline: "Three integrated tools — the Red Team Protocol, the Risk Simulation Lab, and the Pre-Mortem Diagnostic — each grounded in an established intellectual tradition and adapted for structured, continuous, board-level governance challenge."
description: "The Adversarial Methodology from Marentis Labs: Red Team Protocol, Risk Simulation Lab, and Pre-Mortem Diagnostic — the three tools that constitute the operational substance of SGaaS."
tools: ["Red Team Protocol", "Risk Simulation Lab", "Pre-Mortem Diagnostic"]
best_for: "Deployed within every SGaaS engagement, calibrated to the tier. Available as standalone applications for discrete strategic decisions or governance moments."
duration: "Cadence varies by tool — continuous, periodic, and event-driven respectively"
tier: "Deployed across all SGaaS tiers"
cta_label: "Discuss the Methodology"
cta_heading: "Bring the Adversarial Methodology to Your Board"
cta_body: "Embedded within a retained engagement, or available standalone for a discrete strategic decision."
permalink: /services/adversarial-methodology/
---
...
The output is a structured failure-mode map: a documented catalogue of the ways in which the decision might fail, weighted by frequency of identification and assessed for plausibility. The map does not tell the board what to decide. It tells the board what it is risking, with the benefit of the documented improvement in causal reasoning that prospective hindsight provides.

The Pre-Mortem Diagnostic primarily addresses the structural defect of **episodic engagement** — making risk engagement a prerequisite of significant decisions, not a periodic review conducted between them.
...
Two operational principles run through all three. First, the **analytical burden is carried by the SGaaS principal, not the board** — assumption mapping, document review, adversarial scenario construction, and coordination with the second and third lines are conducted asynchronously alongside the organisation's existing governance rhythm. Part-time directors receive distilled, high-signal adversarial intelligence, not raw analytical workload.

Second, **directors are not passive consumers of that intelligence**. Forced independent deliberation — anonymous pre-deliberation assessments of confidence and risk — precedes every structured challenge output, ensuring that the board engages cognitively with the decision before receiving the adversarial analysis.
