...
- An **EBITDA and CAPEX Governance Proof-Book**, a documented review of the governance, hurdle rates, and capital-rationing models that authorised the PortCo's historical CAPEX and bolt-on M&A programmes. It gives the buyer's diligence team empirical proof that the growth investments currently suppressing cash flow were governed under disciplined, high-rate-era hurdle metrics, defending the credibility of the forward EBITDA run-rate.
