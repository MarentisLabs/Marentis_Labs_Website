...
tools: ["Governance Maturity Diagnostic (MRMM)", "Pre-Mortem Diagnostic", "Buyer-Perspective Red Team Protocol", "Buyer-Ready Data Room & Exit-Readiness Opinion"]
...
cta_body: "A principal-signed, buyer-ready governance position that removes the gaps a diligence team would otherwise price against."
...
| Relationship | One-off, transactional | Continuous through the run-up to exit |
